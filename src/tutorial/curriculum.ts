...
export const MATCH_COACH_STEPS: readonly MatchCoachStep[] = [
  ...
  { id: 'defense-stop', screen: 'live', task: 'Stop the defense timer.', detail: 'Do this now: tap the running timer when the robot stops defending.', target: '[data-testid="capture-defense"]', optional: false, action: 'defense_stopped' },
  { id: 'defended-lock', screen: 'live', task: 'Start the defended timer.', detail: 'Do this now: tap Getting defended when an opponent blocks this robot.', target: '[data-testid="capture-defended"]', optional: false, action: 'defended_started' },
  { id: 'defended-stop', screen: 'live', task: 'Stop the defended timer.', detail: 'Do this now: tap the running timer when the opponent stops blocking.', target: '[data-testid="capture-defended"]', optional: false, action: 'defended_stopped' },
  ...
  { id: 'intake', screen: 'review', page: 0, task: 'Mark intake sources.', detail: 'Use this to show where the robot collected fuel.', target: '[data-testid="review-intake-sources"]', optional: true, action: 'intake_sources' },
  { id: 'defense-seconds', screen: 'review', page: 0, task: 'Correct defense time if needed.', detail: 'Use this only when the live defense timer needs a correction.', target: '[data-testid="review-defense-seconds"]', optional: true, action: 'defense_seconds' },
  { id: 'defended-seconds', screen: 'review', page: 0, task: 'Correct defended time if needed.', detail: 'Use this only when the Getting defended timer needs a correction.', target: '[data-testid="review-defended-seconds"]', optional: true, action: 'defended_seconds' },
  { id: 'pins', screen: 'review', page: 0, task: 'Record pins when seen.', detail: 'Use this for the number of clear pinning actions you observed.', target: '[data-testid="review-pins"]', optional: true, action: 'pins' },
  { id: 'capacity', screen: 'review', page: 0, task: 'Record maximum capacity.', detail: 'Use this for the most fuel you saw the robot carry at once.', target: '[data-testid="review-max-capacity"]', optional: true, action: 'max_capacity' },
  { id: 'defense-rating', screen: 'review', page: 0, task: 'Rate defense quality.', detail: 'Use the 1–10 slider only when you saw enough defense to judge it.', target: '[data-testid="review-defense-rating"]', optional: true, action: 'defense_rating' },
  { id: 'driver-rating', screen: 'review', page: 0, task: 'Rate driver skill.', detail: 'Use the 1–10 slider for the driver control you observed.', target: '[data-testid="review-driver-skill"]', optional: true, action: 'driver_rating' },
  { id: 'agility-rating', screen: 'review', page: 0, task: 'Rate agility.', detail: 'Use the 1–10 slider for how quickly and smoothly the robot moved.', target: '[data-testid="review-agility"]', optional: true, action: 'agility_rating' },
  { id: 'rating-clear', screen: 'review', page: 0, task: 'Clear a rating when unsure.', detail: 'Use Clear to return a rating to Not rated. Not rated is better than guessing.', target: '[data-testid="review-defense-rating-clear"]', optional: true, action: 'rating_clear' },
  { id: 'handling-next', screen: 'review', page: 0, task: 'Open the Auto path.', detail: 'Do this now: tap Next.', target: '[data-testid="review-next"]', optional: false, action: 'next' },


  { id: 'auto-path', screen: 'review', page: 1, task: 'Confirm the Auto start and path.', detail: 'Check the start marker, then draw the programmed route when you saw it.', target: '[data-testid="review-field-path"]', optional: true, action: 'auto_path' },
  { id: 'auto-next', screen: 'review', page: 1, task: 'Open the match summary.', detail: 'Do this now: tap Next.', target: '[data-testid="review-next"]', optional: false, action: 'next' },
  ...
  { id: 'summary', screen: 'review', page: 2, task: 'Check the summary.', detail: 'Use this to catch a number that does not match what you saw.', target: '[data-testid="review-summary"]', optional: true },
