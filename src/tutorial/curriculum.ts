...
export const MATCH_COACH_STEPS: readonly MatchCoachStep[] = [
  ...
  { id: 'auto-extras', screen: 'live', task: 'Know the Auto extras.', detail: 'Use Left Line when the robot fully leaves its starting line.', target: '[data-testid="capture-left-line"]', optional: true },
  ...
  { id: 'handling', screen: 'review', page: 0, task: 'Review ratings.', detail: 'Rate only what you confidently observed. Leave uncertain ratings blank.', target: '[data-testid="review-ratings"]', optional: true, action: 'defense_rating' },
