...
export const PIT_COACH_STEPS: readonly PitCoachStep[] = [
  ...
  { id: 'mechanisms', page: 0, task: 'Mark the mechanisms.', detail: 'Choose the intake, shooter, climber, or other important mechanisms the team identifies.', target: '[data-testid="pit-mechanisms"]', optional: true, action: 'mechanism' },
  ...
  { id: 'strategy', page: 2, task: 'Capture strategy and power details.', detail: 'Mark the expected match roles, then add vision, battery, charger, brand, or connector details the team knows.', target: '[data-testid="pit-match-strategy"]', optional: true, action: 'strategy' },
  { id: 'dimensions', page: 3, task: 'Record size and trench fit.', detail: 'Enter bumper-inclusive length and width, normal starting height, and whether the robot fits through the trench.', target: '[data-testid="pit-length"]', optional: true, action: 'length' },
